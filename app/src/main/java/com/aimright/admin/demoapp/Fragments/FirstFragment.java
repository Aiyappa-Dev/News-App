...
import com.aimright.admin.demoapp.Models.fetchUrl.DataUrl;
...
public class FirstFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
   ...
   // TextView newsHeadline;
    ...
    private InfomoAdView bottomBanner;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.recyclerView);
         bottomBanner = view.findViewById(R.id.adViewBottom);
